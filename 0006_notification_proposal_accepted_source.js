...
async function  getProposals()
{
  ...
  await client.connect()
      ...
      const sql_calendars  = "UPDATE proposal SET notification_accepted_proposal_source  = true  WHERE status = 200  AND ( notification_accepted_proposal_source IS NULL OR  notification_accepted_proposal_source = false )  RETURNING * ; "  
